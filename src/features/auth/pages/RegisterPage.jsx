...
export function RegisterPage() {
  ...
  return (
    <AuthShell>
      ...
      <h1 className="text-xl font-bold"><Trans>Crear cuenta gratis</Trans></h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
        ...
        <GlassField
          ...
          {...register('password')}
        />
        <p className="-mt-3 text-xs text-zen-ink/50 dark:text-white/40"><Trans>Mínimo 6 caracteres</Trans></p>
        <GlassField
          id="reg-confirm"
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-xs text-zen-ink/60 dark:text-white/50">
          <span className="bg-transparent px-2 backdrop-blur-sm"><Trans>o regístrate con</Trans></span>
        </div>
      </div>
