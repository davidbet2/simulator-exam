...
- **Cross-platform.** Use Glob, Read, and Grep tools -- not Bash `ls`, `find`, or `cat`. Bash file commands fail on Windows. Only use Bash for `node C:/Users/david.betancur_pragm/Desktop/Proyectos/base-project/.claude/get-shit-done/bin/gsd-tools.cjs intel` CLI calls.
...
```bash
node C:/Users/david.betancur_pragm/Desktop/Proyectos/base-project/.claude/get-shit-done/bin/gsd-tools.cjs intel patch-meta .planning/intel/stack.json --cwd <project_root>
```
...
```bash
node C:/Users/david.betancur_pragm/Desktop/Proyectos/base-project/.claude/get-shit-done/bin/gsd-tools.cjs intel patch-meta .planning/intel/files.json --cwd <project_root>
```
...
```bash
node C:/Users/david.betancur_pragm/Desktop/Proyectos/base-project/.claude/get-shit-done/bin/gsd-tools.cjs intel patch-meta .planning/intel/apis.json --cwd <project_root>
```
...
```bash
node C:/Users/david.betancur_pragm/Desktop/Proyectos/base-project/.claude/get-shit-done/bin/gsd-tools.cjs intel patch-meta .planning/intel/deps.json --cwd <project_root>
```
...
Run: `node C:/Users/david.betancur_pragm/Desktop/Proyectos/base-project/.claude/get-shit-done/bin/gsd-tools.cjs intel validate --cwd <project_root>`
...
Run: `node C:/Users/david.betancur_pragm/Desktop/Proyectos/base-project/.claude/get-shit-done/bin/gsd-tools.cjs intel snapshot --cwd <project_root>`
