...
<execution_context>
@C:/Users/david.betancur_pragm/Desktop/Proyectos/base-project/.claude/get-shit-done/workflows/execute-plan.md
@C:/Users/david.betancur_pragm/Desktop/Proyectos/base-project/.claude/get-shit-done/templates/summary.md
</execution_context>
...
```bash
INIT=$(node "C:/Users/david.betancur_pragm/Desktop/Proyectos/base-project/.claude/get-shit-done/bin/gsd-tools.cjs" init plan-phase "${PHASE}")
...
```bash
node "C:/Users/david.betancur_pragm/Desktop/Proyectos/base-project/.claude/get-shit-done/bin/gsd-tools.cjs" history-digest
```
...
@C:/Users/david.betancur_pragm/Desktop/Proyectos/base-project/.claude/get-shit-done/references/thinking-models-planning.md
...
```bash
VALID=$(node "C:/Users/david.betancur_pragm/Desktop/Proyectos/base-project/.claude/get-shit-done/bin/gsd-tools.cjs" frontmatter validate "$PLAN_PATH" --schema plan)
```
...
```bash
STRUCTURE=$(node "C:/Users/david.betancur_pragm/Desktop/Proyectos/base-project/.claude/get-shit-done/bin/gsd-tools.cjs" verify plan-structure "$PLAN_PATH")
```
...
```bash
node "C:/Users/david.betancur_pragm/Desktop/Proyectos/base-project/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): create phase plan" --files .planning/phases/$PHASE-*/$PHASE-*-PLAN.md .planning/ROADMAP.md
```
</step>
