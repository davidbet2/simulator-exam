...
- Reportar si una dependencia tiene CVEs conocidos
...
- Los logs de seguridad deben ser append-only
...
Si se detectan estos patterns en el código fuente, alertar inmediatamente:
